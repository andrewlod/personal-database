...
class RAGService:
    ...
    async def query(self, question: str, top_k: Optional[int] = None, 
    ...
    async def add_documents(self, documents: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        try:
            ...
            success = await self.vector_db_service.add_vectors(
                vectors=embeddings,
                payloads=valid_docs,
                ids=[doc.get('chunk_id', f"doc_{i}") for i, doc in enumerate(valid_docs)]
            )
            ...
            return {
                ...
                "chunks_created": len(valid_docs),  # Assuming 1 chunk per document for simplicity
    ...
    def _prepare_context(self, search_results: List[Dict[str, Any]]) -> str:
        ...
        for i, result in enumerate(search_results, 1):
            ...
            if content:
                context_part = f"[Source {i}: {title} (Relevance: {score:.2f})]\n{content}\n"
    ...
    async def _generate_response(self, question: str, context: str, 
                               temperature: float, max_tokens: int) -> tuple[str, Dict[str, Any]]:
        """
...
Answer:"""
    ...
    def _generate_fallback_response(self, question: str, context: str) -> str:
        ...
        if relevant_lines:
            ...
            answer = "Based on the information in your knowledge base:\n\n" + "\n\n".join(top_lines)
