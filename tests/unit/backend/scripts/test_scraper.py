...
class TestWebScraper:
    ...
    def test_scrape_urls(self, mock_scrape_url):
        ...
        mock_scrape_url.side_effect = [
            {'title': 'Page 1', 'content': 'Content 1', 'url': 'http://example1.com', 'timestamp': 123, 'word_count': 10},
            {'title': 'Page 2', 'content': 'Content 2', 'url': 'http://example2.com', 'timestamp': 456, 'word_count': 20},
            None
        ]
