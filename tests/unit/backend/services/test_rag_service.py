...
class TestRAGService:
    ...
    async def test_query_success(self):
        ...
        with patch('httpx.AsyncClient', return_value=mock_async_context_manager):
            ...
            mock_embedding_service.embed_query.assert_called_once_with("What is machine learning?")
    ...
    async def test_get_stats(self):
        ...
        # Mock service stats
        mock_vector_db_service.get_stats = AsyncMock(return_value={
            'class_name': 'PersonalKnowledge',
            'object_count': 100
        })
        mock_embedding_service.get_stats = Mock(return_value={
